      ...
      <section className="contact">
        ...
        <div>
          ...
          <div className="formStyle">
            ...
            <TextField style={{ marginBottom: "20px", width: "300px" }} label="Name" variant="outlined" />
            <TextField style={{ marginBottom: "20px", width: "300px" }} label="Email" variant="outlined" />
            <TextareaAutosize style={{ height: "80px", padding: "20px" }} aria-label="empty textarea" placeholder="Enter your message" maxLength={200} minRows={4}></TextareaAutosize>
