...
const MainPage = ({ productItems }) => {
  ...
  const [reviews, setReviews] = useState([{
    feedback: " Most of my decorative cosmetics collection consists of products bought here. The quality of their goods is always top- notch, and the service is very pleasant.",
    img: client1,
    name: "YULIA VERBYNETS"
  },
  {
    feedback: " This store is my favorite place to shop for decorative cosmetics! They always have awide range of products that meet all my needs. I love their promotions and expertadvice. Highly recommended!",
    img: client2,
    name: "DASHA ASTAFIEVA"
  },
  {
    feedback: " Most of my decorative cosmetics collection consists of products bought here. Thequality of their goods is always top-notch, and the service is very pleasant. I'm ahappy customer, and I will definitely be back",
    img: client3,
    name: "NADYA DOROFEEVA"
  },]);
      ...
      <section className="customer_reviews">
        ...
        <div className="review_wrap" >
          {currentReviews.map((review, index) => (
            <div className="review" style={{ width: "calc(33.33% - 20px)" }}>
              <div>
